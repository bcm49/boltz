"""
file passed to pqr_to_coordinates_center should be the pocket{i}_vert.pqr file in model_0_out/pockets after running fpocket -f {file}.pdb
"""

def pqr_to_coordinates_center(file):
    input_file = file
    coordinates = []
